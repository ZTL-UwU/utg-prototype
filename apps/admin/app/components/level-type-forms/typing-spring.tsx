...
import { typingSpringPropsSchema, type TypingSpringProps } from '@utg/level-types';
...
export function TypingSpringPropsForm({
  defaultValues,
  onSubmit,
  onDirtyChange,
}: LevelPropsFormProps<TypingSpringProps>) {
  const form = useForm({
    defaultValues,
    validators: { onSubmit: typingSpringPropsSchema },
