...
export class MainScreen extends Container {
  ...
  constructor() {
    ...
    this.pauseButton.onPress.connect(() => engine().navigation.showPopup(PausePopup));
    ...
    this.settingsButton.onPress.connect(() => engine().navigation.showPopup(SettingsPopup));
  ...
  public async show(): Promise<void> {
    void engine().audio.bgm.play('main/sounds/bgm-main.mp3', { volume: 0.5 });
